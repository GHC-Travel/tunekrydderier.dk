<form>
    <div>
        ...
        @if($this->readyToSelectDelivery)
            <div class="mt-8 border-t border-gray-200 pt-8 sm:mt-5 sm:pt-10 transition duration-150 ease-in-ou">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-orange-600">
                        {{ __('Delivery') }}
                    </h3>
                ...
                @if(!empty($deliveryProviderAddresses))
